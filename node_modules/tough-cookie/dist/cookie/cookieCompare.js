...
function cookieCompare(a, b) {
    validators.validate(validators.isObject(a), (0, utils_1.safeToString)(a));
    validators.validate(validators.isObject(b), (0, utils_1.safeToString)(b));
    let cmp;
